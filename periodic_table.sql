...
--
-- Name: elements name_unq; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements symbol_unq; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: properties foreign_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT foreign_key FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
